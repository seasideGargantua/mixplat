...
spherical_harmonics_3d_fast_forward = _make_lazy_cuda_func("spherical_harmonics_3d_fast_forward")
spherical_harmonics_3d_fast_backward = _make_lazy_cuda_func("spherical_harmonics_3d_fast_backward")
